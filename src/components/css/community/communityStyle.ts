...
export {
  ...
  PopularLayoutGrid, ShorteningP, CommumityLikeRevieLayout, SearchIcons, SettingBtn, PerDiv, CommunityCommentText,
  CommunityCommentTextBtn, CommunityDetilHeart, PostWriteTag, PostTagSelector, PostPreImgBox,
  CommunityTextArea, CommuityTextaAreaCount, CommuityWriteInput
}