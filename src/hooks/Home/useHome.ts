...
export const useHome = (): Type.useHome => {
	...
	const videoUrl: string =
		"https://finalimgbucket.s3.ap-northeast-2.amazonaws.com/61bd94a0-39e9-4aff-a677-dfc4167be03b";
	...
	return { sectionRef1, sectionRef2, sectionRef3, sectionRef4, sectionRef5, sectionContentRef, videoUrl };
};
